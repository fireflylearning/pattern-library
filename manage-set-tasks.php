<? require_once '_htmlhead.php'; ?>
	...
	<div class="pattern">
        ...
        <div class="ff-content-primary">
	        
			<div class="ff-actions pagetoolsbtns ff-page-actions">
				<div class="ff-actions-primary ff-actions-title">
					<span>You have <strong>18</strong> tasks to manage</span>
				</div>
				<div class="ff-actions-secondary">
					
						<div class="ff-nav-switch">
							<p class="ff-nav-switch-label">Sort By</p>
							<ul class="ff-nav-switch-items">
								<li class="unselected"><a href="#">Due</a></li>
									<li class="selected ff-icon ff-icon-selected"><span>Set</span></li>
							</ul>
						</div>
		...
		<div class="ff-content-secondary">
