<xsl:template name="ff_module-input-checkbox">
    <xsl:param name="data" />
    <xsl:variable name="input" select="$data//input"/>


    <div class="ff_module-input-checkbox">
        <input type="checkbox" class="ff_module-input-checkbox__input">
        ...
        <label class="ff_module-input-checkbox__label">
            <xsl:if test="not($input/@id='')">
