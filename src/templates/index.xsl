...
<xsl:stylesheet version="1.0"
    ...
    {% include './includes/output-blocks.xsl' with { blocks: site.blocks} %}
    {% include './includes/block-preview-listing.xsl' with { blocks: site.blocks} %}
    ...
    <xsl:template match="/">
        ...
        <body>
            ...
            <div class="crate-wrapper">
                ...
                <div class="crate-nav">
                <h3>Blocks</h3>
                {% include './includes/block-nav-listing.xsl' with { blocks: site.blocks}%}
                <h3>Pages</h3>
                {% include './includes/page-listing.xsl' with { pages: site.pages} %}
                </div>
            </div>
