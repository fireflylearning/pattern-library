<xsl:template name="ff_module-form-box-member">
    ...
    <div class="ff_module-form-box-member">
        ...
        <button class="ff_module-form-box-member__edit" data-edit="{$input/@id}" type="button" >
            <span class="ff_icon ff_icon-edit-input-box"></span>
        </button>
        <span class="ff_module-form-box-member__label"><xsl:value-of select="$input" /></span>
        <button class="ff_module-form-box-member__delete" data-delete="${input/@id}" type="button">
