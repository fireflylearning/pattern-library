<xsl:template name="ff_module-button">
  <xsl:param name="data" />
  <xsl:choose>
    <xsl:when test="$data/button/@href">
      <form class="ff_module-button__inline-form" action="{$data/button/@href}">
        <xsl:call-template name="ff_module-button--element">
...
<xsl:template name="ff_module-button--element">
  <xsl:param name="data" />
